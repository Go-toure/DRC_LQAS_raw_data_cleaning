...
# AB <- read_excel("Zambia_SIA_LQAS.xlsx")
AB <- read_csv("DRC_SIA_LQAS_.csv")
names(AB)
AC<- AB |> 
  # for Ghana
  # mutate(Country = "GHA") |>
...
write_csv(F7,"C:/Users/TOURE/Mes documents/REPOSITORIES/LQAS_raw_data/LQAS_level1/RDC_LQAS.csv")
